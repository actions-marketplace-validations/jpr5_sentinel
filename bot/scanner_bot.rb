    ...
    class ScannerBot
        ...
        def build_pr_body(repo:, rule:, severity:, findings:, fix_description:)
            ...
            **#{severity}: #{rule}** (#{findings.length} finding#{"s" if findings.length > 1})
            ...
            ---
            <sub>&#x1f6e1;&#xfe0f; This PR was generated by [Sentinel](https://sentinel.copilotkit.dev), an open-source CI/CD security scanner. [Why this PR?](https://medium.com/@jordanritter/hardening-github-actions-at-scale) · Free, no tracking</sub>
        ...
        def build_advisory_content(rule, findings)
            ...
            lines << "[Why this PR?](https://medium.com/@jordanritter/hardening-github-actions-at-scale) · "
