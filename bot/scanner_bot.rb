...
module Bot
    class ScannerBot
        ...
        def create_fix_pr(repo, rule, findings)
            ...
            branch = "gh-workflow-scanner/fix-#{rule}"
        ...
        def create_advisory_pr(repo, rule, findings)
            first = findings.first
            branch = "gh-workflow-scanner/advisory-#{rule}"
        ...
        def build_advisory_content(rule, findings)
            ...
            lines << "This file was added by [gh-workflow-scanner](https://github.com/jpr5/gh-workflow-scanner) "
